...
public class MainExt {
    ...
    public static void main(String[] args) {
        // 문자에서 int, Integer로 변환 : String -> int, Integer
        Integer toInt1 = Integer.valueOf(TO_INT);                           //  returns Integer
        int toInt2 = Integer.parseInt(TO_INT);                              //  returns int
        Integer toIntNegative1 = Integer.valueOf(TO_INT_NEGATIVE);          //  return Integer
        int toIntNegative2 = Integer.parseInt(TO_INT_NEGATIVE);             //  return int

        // 문자에서 long, Long 으로 변환
        ...
        System.out.println(TO_INT_NEGATIVE + ":\n int는 " + toIntNegative2 +
                "\n Integer는 " + toIntNegative1);

        System.out.println(TO_LONG + ":\n int는 " + toLong2 + "\n Integer는 " + toLong1);
        System.out.println(TO_LONG_NEGATIVE + ":\n int는 " + toLongNegative2 +
                "\n Integer는 " + toLongNegative1);

        System.out.println(TO_FLOAT + ":\n int는 " + toFloat2 + "\n Integer는 " + toFloat1);
        System.out.println(TO_FLOAT_NEGATIVE + ":\n int는 " + toFloatNegative2 +
                "\n Integer는 " + toFloatNegative1);

        System.out.println(TO_DOUBLE + ":\n int는 " + toDouble2 + "\n Integer는 " + toDouble1);
        System.out.println(TO_DOUBLE_NEGATIVE + ":\n int는 " + toDoubleNegative2 +
                "\n Integer는 " + toDoubleNegative1);
